...
const products = require('../models/dbEditProductsModel');
...
//         console.log(error);
//     });
    // var sql = "SELECT products.*, city.city_name, statusssss.status_name, city.currency_name FROM products JOIN city, statusssss WHERE city.id = products.city AND statusssss.id = products.status AND products.lender_id = '" + connection.escape(lender_id) + "' ";
...
//     var sql = 'SELECT products.*, city.city_name, statusssss.status_name FROM products JOIN city, statusssss WHERE city.id = products.city AND statusssss.id = products.status order BY id DESC;';
//     db.query(sql, function (err, data, fields) {
//         if (err) throw err;
//         res.json(data)
//     });
